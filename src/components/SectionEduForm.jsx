...
function SectionEduForm(props){
    return (
        <form onSubmit={props.handleSubmit} className='inputsEducation'>
            ...
            <Input label="Location" name="location" value={props.degrees.find( c=> c.id ===props.lastDegreeId).degree.location} handleChange={() => props.handleEditDegrees(event,props.lastDegreeId)} placeholder="Enter location" optional={false} />
